...
// Console.
Protocol.inspectorBackend.registerEnum("Console.ConsoleMessageSource", {XML: "xml", Javascript: "javascript", Network: "network", ConsoleAPI: "console-api", Storage: "storage", Appcache: "appcache", Rendering: "rendering", Security: "security", Other: "other", Deprecation: "deprecation", Worker: "worker"});
Protocol.inspectorBackend.registerEnum("Console.ConsoleMessageLevel", {Log: "log", Warning: "warning", Error: "error", Debug: "debug", Info: "info"});
Protocol.inspectorBackend.registerEvent("Console.messageAdded", ["message"]);
Protocol.inspectorBackend.registerCommand("Console.clearMessages", [], [], false);
Protocol.inspectorBackend.registerCommand("Console.disable", [], [], false);
Protocol.inspectorBackend.registerCommand("Console.enable", [], [], false);
