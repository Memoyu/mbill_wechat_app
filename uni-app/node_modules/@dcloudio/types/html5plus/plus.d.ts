...
interface PlusAudio {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/audio.html](http://www.html5plus.org/doc/zh_cn/audio.html)
     */
    createPlayer(path?: '_www/' | '_doc/' | '_documents/' | '_downloads/'): PlusAudioAudioPlayer;
}
...
interface PlusIo {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
     */
    resolveLocalFileSystemURL(url ?: '_www/' | '_doc/' | '_documents/' | '_downloads/', succesCB?: (result: PlusIoDirectoryEntry) => void, errorCB?: (result: any) => void): void;
    /**
     * 将本地URL路径转换成平台绝对路径
